...
export const products: Product[] = [
  // PREMIUM DATES
  {
    ...
    image: '/Products/medjool-dates1.jpg',
    images: ['/Products/medjool-dates1.jpg', '/Products/medjool-dates2.jpg', '/Products/medjool-dates3.jpg'],
    inStock: true,
    inventory: 250,
    unit: 'kg',
    featured: true,
  ...
  },
  {
    ...
    image: '/Products/ajwa-dates1.jpg',
    images: ['/Products/ajwa-dates1.jpg', '/Products/ajwa-dates2.jpg', '/Products/ajwa-dates3.jpg'],
    inStock: true,
    inventory: 120,
    unit: 'kg',
    featured: true,
  ...
  },
  {
    ...
    image: '/Products/kimia1.jpg',
    images: ['/Products/kimia1.jpg', '/Products/kimia2.jpg'],
    inStock: true,
    inventory: 300,
    unit: 'kg',
    featured: true,
  ...
  },
  {
    ...
    image: '/Products/safawi-dates1.jpg',
    images: ['/Products/safawi-dates1.jpg', '/Products/safawi-dates2.jpg', '/Products/safawi-dates3.jpg'],
    inStock: true,
    inventory: 180,
    unit: 'kg',
    featured: false,
  ...
  },
  {
    ...
    image: '/Products/mabroom-dates1.jpg',
    images: ['/Products/mabroom-dates1.jpg', '/Products/mabroom-dates2.jpg', '/Products/mabroom-dates3.jpg'],
    inStock: true,
    inventory: 150,
    unit: 'kg',
    featured: false,
  ...
  // DRY FRUITS
  {
    ...
    image: '/Products/golden-raisins1.jpg',
    images: ['/Products/golden-raisins1.jpg', '/Products/golden-raisins2.jpg', '/Products/golden-raisins3.jpg'],
    inStock: true,
    inventory: 400,
    unit: 'kg',
    featured: true,
  ...
  },
  {
    ...
    image: '/Products/turkish-apricots1.jpg',
    images: ['/Products/turkish-apricots1.jpg', '/Products/turkish-apricots2.jpg', '/Products/turkish-apricots3.jpg'],
    inStock: true,
    inventory: 220,
    unit: 'kg',
    featured: true,
  ...
  },
  {
    ...
    image: '/Products/dried-figs1.jpg',
    images: ['/Products/dried-figs1.jpg', '/Products/dried-figs2.jpg', '/Products/dried-figs3.jpg', '/Products/dried-figs4.jpg'],
    inStock: true,
    inventory: 280,
    unit: 'kg',
    featured: false,
